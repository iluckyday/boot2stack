...
include_apps="systemd,systemd-resolved,dbus,systemd-sysv,sudo,bash-completion,openssh-server,tcpdump,isc-dhcp-client"
...
qemu-img convert -c -f raw -O qcow2 /tmp/sid.raw /dev/shm/stack-br-c.img
